...
To learn more about programming with R, we highly recommend checking out the online courses offered by [Datacamp](https://www.datacamp.com/), which includes both introductory and advanced courses within the [R track](https://www.datacamp.com/courses/tech:r). Datacamp is all online with many free courses (only the first chapter of courses are usually free!), with videos and a code editor/console that promotes an interactive learning experience. What we like about Datacamp is that it is more focused on topics and programming paradigms that center around data science, which is especially helpful for getting started with R. 
